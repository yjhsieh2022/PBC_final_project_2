...
def create_p3_template(routes_num, r_trans_num, API_Result, Price, ticket):
# 中間變數先填好
    # 儲存中間的html碼
    with open(file='C:\\Users\\宜蓁\\Documents\\大五\\python\\final_project\\WJtest\\templates\\p3_test21.html', mode='r', encoding='utf-8') as html_21:
        html_21_Lines = html_21.readlines()
    with open(file='C:\\Users\\宜蓁\\Documents\\大五\\python\\final_project\\WJtest\\templates\\p3_test221.html', mode='r', encoding='utf-8') as html_221:
        html_221_Lines = html_221.readlines()
    with open(file='C:\\Users\\宜蓁\\Documents\\大五\\python\\final_project\\WJtest\\templates\\p3_test222.html', mode='r', encoding='utf-8') as html_222:
        html_222_Lines = html_222.readlines()
    with open(file='C:\\Users\\宜蓁\\Documents\\大五\\python\\final_project\\WJtest\\templates\\p3_test23.html', mode='r', encoding='utf-8') as html_23:
    ...
    with open(file='C:\\Users\\宜蓁\\Documents\\大五\\python\\final_project\\WJtest\\templates\\p3_test2.html', mode='w', encoding='utf-8') as html_2:
        html_2.writelines(html_21_Lines)
    for tran_num in range(r_trans_num):  # 幾種交通工具複製幾次
        with open(file='C:\\Users\\宜蓁\\Documents\\大五\\python\\final_project\\WJtest\\templates\\p3_test2.html', mode='a', encoding='utf-8') as html_2:
            if Price[route_num][tran_num][1] != None: 
                if API_Result[route_num][tran_num][0] == 'BUS': # BUS的API輸出順序跟其他車種不一樣，對應位置要變
                    for line in Change_221_Lines:
                        ...
                        line = line.replace("price", str(pricelist(ticket, Price)[route_num][tran_num]))
    ...
    with open(file='C:\\Users\\宜蓁\\Documents\\大五\\python\\final_project\\WJtest\\templates\\p3_test2.html', mode='a', encoding='utf-8') as html_2:
        for line in Change_23_Lines:
            ...
            line = line.replace("pricesum", str(pricesum(pricelist(ticket, Price))[route_num]))
            html_2.write(line)

    # 儲存html碼
    with open(file='C:\\Users\\宜蓁\\Documents\\大五\\python\\final_project\\WJtest\\templates\\p3_test1.html', mode='r', encoding='utf-8') as begin:
        Begin_Lines = begin.readlines()
    with open(file='C:\\Users\\宜蓁\\Documents\\大五\\python\\final_project\\WJtest\\templates\\p3_test2.html', mode='r', encoding='utf-8') as middle:
        Middle_Lines = middle.readlines()
    with open(file='C:\\Users\\宜蓁\\Documents\\大五\\python\\final_project\\WJtest\\templates\\p3_test3.html', mode='r', encoding='utf-8') as end:
        End_Lines = end.readlines()

    # 寫進template
    with open(file='C:\\Users\\宜蓁\\Documents\\大五\\python\\final_project\\WJtest\\templates\\p3_test.html', mode='w', encoding='utf-8') as combination:
        combination.writelines(Begin_Lines)
    with open(file='C:\\Users\\宜蓁\\Documents\\大五\\python\\final_project\\WJtest\\templates\\p3_test.html', mode='a', encoding='utf-8') as combination:
...
create_p3_template(route_num, r_trans_num, API_Result, Price, ticket)